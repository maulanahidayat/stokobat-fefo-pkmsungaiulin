...
$where = "WHERE b.stok > 0 AND b.tgl_kadaluarsa < CURDATE()";
if ($search != '') {
...
$query = "SELECT b.*, o.kode_obat, o.nama_obat, s.nama_satuan, DATEDIFF(CURDATE(), b.tgl_kadaluarsa) as lewat_hari
          FROM batch_obat b 
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Laporan Obat Sudah Kadaluarsa</h2>
...
<div class="card shadow">
    <div class="card-body">
        <div class="alert alert-danger"><strong>Perhatian:</strong> Obat di bawah ini tidak dapat dikeluarkan karena telah melewati masa kadaluarsa dan harus segera dimusnahkan.</div>
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-danger"><?= $row['lewat_hari']; ?> Hari</span></td>
                    <td><?= $row['stok'] . ' ' . $row['nama_satuan']; ?></td>
                </tr>
                <?php endwhile; ?>
                <?php if(mysqli_num_rows($ed) == 0): ?>
                <tr><td colspan="6" class="text-center">Tidak ada obat yang sudah kadaluarsa bersisa stok.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<style>
    @media print {
        #sidebar, .navbar, .btn, .alert, .no-print {
